...
class ContractDetail extends Component {
    ...
    renderConfirmDialog() {
        const {isOpen, modalTitle, modalDescription, contractState, closeOneContract} = this.state;
        return (
            <Modal isOpen={isOpen} className="confirm-dialog" aria-labelledby="contained-modal-title-vcenter" centered>
                ...
                <ModalBody>
                    ...
                    <div className="footer">
                        ...
                        {closeOneContract? <button className="btn btn-success" id="close_one_confirm" onClick={this.handleClick}>Yes</button> : <>
                        {contractState === 'normal'?
                            <button className="btn btn-success" id="close_all_confirm" onClick={this.handleClick}>Yes</button>:
                            (contractState === 'closed'?<button className="btn btn-success" id="archieve_all_confirm" onClick={this.handleClick}>Yes</button>:null)}</>}
            ...
            <div className="detail-container">
                ...
                <section>
                    <div className="fixed-row">
                        {isHirerView === true?(contractState === 'normal'?
                            <button className="btn btn-success btn-sm" id="close_all_contracts" onClick={this.handleClick}>Close all contracts</button>:
                             (contractState === 'closed'?<button className="btn btn-success btn-sm" id="archieve_all_contracts" onClick={this.handleClick}>Archive all contracts</button>:null)):
                             (contractState === 'normal'?
                            <button className="btn btn-success btn-sm" id="close_contract" onClick={this.handleClick}>Close contract</button>:
                             (contractState === 'closed'?<button className="btn btn-success btn-sm" id="archieve_contract" onClick={this.handleClick}>Archive contract</button>:null))}
                    </div>
                </section>
